...
public:
	...
	BOOL Create( HWND hWndParent, HINSTANCE hInstance, LPCTSTR lpszWindowText = LIST_BOX_WINDOW_CLASS_DEFAULT_TEXT, DWORD dwExStyle = LIST_BOX_WINDOW_CLASS_DEFAULT_EXTENDED_STYLE, DWORD dwStyle = LIST_BOX_WINDOW_CLASS_DEFAULT_STYLE, HMENU hMenu = LIST_BOX_WINDOW_CLASS_DEFAULT_MENU, int nLeft = LIST_BOX_WINDOW_CLASS_DEFAULT_LEFT, int nTop = LIST_BOX_WINDOW_CLASS_DEFAULT_TOP, int nWidth = LIST_BOX_WINDOW_CLASS_DEFAULT_WIDTH, int nHeight = LIST_BOX_WINDOW_CLASS_DEFAULT_HEIGHT, LPVOID lpParam = LIST_BOX_WINDOW_CLASS_DEFAULT_LP_PARAM );
