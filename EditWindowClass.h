...
public:
	...
	BOOL Create( HWND hWndParent, HINSTANCE hInstance, LPCTSTR lpszWindowText = EDIT_WINDOW_CLASS_DEFAULT_TEXT, DWORD dwExStyle = EDIT_WINDOW_CLASS_DEFAULT_EXTENDED_STYLE, DWORD dwStyle = EDIT_WINDOW_CLASS_DEFAULT_STYLE, HMENU hMenu = EDIT_WINDOW_CLASS_DEFAULT_MENU, int nLeft = EDIT_WINDOW_CLASS_DEFAULT_LEFT, int nTop = EDIT_WINDOW_CLASS_DEFAULT_TOP, int nWidth = EDIT_WINDOW_CLASS_DEFAULT_WIDTH, int nHeight = EDIT_WINDOW_CLASS_DEFAULT_HEIGHT, LPVOID lpParam = EDIT_WINDOW_CLASS_DEFAULT_LP_PARAM );
