...
public:
	...
	BOOL Create( LPCTSTR lpszClassName, HWND hWndParent, HINSTANCE hInstance, LPCTSTR lpszWindowTitle = WINDOW_CLASS_DEFAULT_TITLE, HMENU hMenu = WINDOW_CLASS_DEFAULT_MENU, DWORD dwExStyle = WINDOW_CLASS_DEFAULT_EXTENDED_STYLE, DWORD dwStyle = WINDOW_CLASS_DEFAULT_STYLE, int nLeft = WINDOW_CLASS_DEFAULT_LEFT, int nTop = WINDOW_CLASS_DEFAULT_TOP, int nWidth = WINDOW_CLASS_DEFAULT_WIDTH, int nHeight = WINDOW_CLASS_DEFAULT_HEIGHT, LPVOID lpParam = WINDOW_CLASS_DEFAULT_PARAM );
